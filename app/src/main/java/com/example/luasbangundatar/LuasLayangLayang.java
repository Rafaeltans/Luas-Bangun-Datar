    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(LuasLayangLayang.this, MainActivity.class);
        ...
        btnHitung.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(strd1) || TextUtils.isEmpty(strd2)) {
                    Toast.makeText(LuasLayangLayang.this, "Diagonal 1 dan Diagonal 2 Harus Di Isi", Toast.LENGTH_SHORT).show();
                } else {
